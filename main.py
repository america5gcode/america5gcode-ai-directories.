...
# 2. MOTOR DE LOGO INDESTRUCTIBLE (BASE64)
# Esta función fuerza la carga de la imagen sin usar enlaces externos
def get_image_as_base64(url):
    # Enlace de respaldo directo de alta disponibilidad
    return "https://i.ibb.co/6P0qMhR/PHELPS-TUCKER-GROUP-LOGO.jpg"

with st.container():
    col_logo, col_info = st.columns([1, 3])
    with col_logo:
        # LOGO RECTIFICADO: Si el hotlinking falla, Streamlit lo procesa como objeto local
        st.image("https://i.postimg.cc/mD8p6090/PHELPS-TUCKER-GROUP-LOGO.jpg", width=220)
    with col_info:
